...
public class Assignment2a {
	...
	public static void main(String[] args)
	{
		...
		driver.findElement(By.id("createContactForm_lastNameLocal")).sendKeys("vathsav");
		driver.findElement(By.id("createContactForm_departmentName")).sendKeys("Mechanical");
		driver.findElement(By.id("createContactForm_description")).sendKeys("random thoughts");
		driver.findElement(By.id("createContactForm_primaryEmail")).sendKeys("newmail@newmail.com");
		...
		driver.findElement(By.id("updateContactForm_description")).sendKeys("funny thoughts");
